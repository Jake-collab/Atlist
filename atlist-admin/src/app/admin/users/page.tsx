...
type Profile = { id: string; email: string | null; username: string | null; role: string | null; created_at: string | null };
    ...
    <main className={styles.main}>
      <div className={styles.centerColumn}>
        ...
        <div className={styles.listCard}>
          ...
          {profiles.map((p) => (
            <Link key={p.id} href={`/admin/users/${p.id}`} className={styles.listRow}>
              <span>{p.email ?? "—"}</span>
